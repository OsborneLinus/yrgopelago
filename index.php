...
<body>
    ...
    <section class="flex flex-col">
        ...
        <div class="custom flex flex-col md:grid grid-cols-2 text-center self-center">
            ...
            <div class="bg-green-800 flex flex-col justify-center items-center rounded-b-2xl md:rounded-none md:rounded-r-2xl">
        ...
        <div class="mb-5">
            ...
            <div class="flex flex-col md:flex-row gap-10 items-center justify-center">
                <div class="custom relative group">
                    ...
                    <img class="rounded-lg" src="media/dolphins.jpg" alt="dolphins swimming">
