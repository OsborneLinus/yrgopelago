...
<section class="flex border-green-950 border-solid border-2 rounded-lg flex-col m-8 h-full md:m-8 md:grid grid-cols-2">
    ...
    <div class="bg-no-repeat h-fit m-8">
        <img class="rounded-2xl md:ml-2" src="media/enPalmochHotell.jpg" alt="Outskirts of an island with view over water">
    </div>
    ...
    <div class="flex flex-col mb-10 p-4">
...
<section class="flex flex-col m-8" id="rooms">
    ...
    <div class="custom flex flex-col md:grid grid-cols-2 text-center self-center">
        <div>
            <img class="rounded-t-2xl md:rounded-none md:rounded-l-2xl" id="picture1" src="media/SuperiorRoom.jpg" alt="Picture of the Standard based room">
        </div>
        <div class="bg-green-950 flex flex-col justify-center items-center rounded-b-2xl md:rounded-none md:rounded-r-2xl">
    ...
    <div class="custom flex flex-col md:grid grid-cols-2 mt-5 text-center self-center">
        <div>
            <img class="rounded-t-2xl md:rounded-none md:rounded-l-2xl" id="picture2" src="media/DeluxeRoom.jpg" alt="Picture 2">
        </div>
        <div class="bg-green-950 flex flex-col justify-center items-center rounded-b-2xl md:rounded-none md:rounded-r-2xl">
    ...
    <div class="custom flex flex-col md:grid grid-cols-2 text-center mt-5 self-center">
        <div>
            <img class="rounded-t-2xl md:rounded-none md:rounded-l-2xl" id="picture3" src="media/StandardRoom.jpg" alt="Picture 3">
        </div>
        <div class="bg-green-950 flex flex-col justify-center items-center rounded-b-2xl md:rounded-none md:rounded-r-2xl">
